  ...
  Widget _buildIntroSlide(
    ...
    return Column(
      ...
      children: [
        ...
        Transform.translate(
            offset: const Offset(0, -80), child: Image.asset(image2)),
        Text(
          subtitle,
          textAlign: TextAlign.center,
          style: const TextStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              textAlign: TextAlign.center,
              style: const TextStyle(
                  fontSize: 16, color: Colors.grey, fontFamily: 'Exo2'),
            ),
            ...
            ElevatedButton(
              ...
              child: Text(
                "Let's Get Started",
                style: const TextStyle(
                    fontSize: 18, color: Colors.white, fontFamily: 'Exo2'),
              ),
            ),
          ],
        ),
