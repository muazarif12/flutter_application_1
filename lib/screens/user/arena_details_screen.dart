...
class ArenaDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          arena['name'],
          style: TextStyle(fontFamily: 'Exo2', fontSize: 20, fontWeight: FontWeight.bold, color: Colors.blue),
        ),
        actions: [
          IconButton(
        ...
        child: Column(
          children: [
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    label: Text("Open in Maps", style: TextStyle(color:Colors.blue),),
                  ),
                ],
              ),
            ),
            ...
            _card(
              isDarkMode: isDarkMode,
              title: 'Description',
              child: Text('This is a great place for sports lovers. The owner is John Doe.', style: TextStyle(color: Colors.blue)),
            ),
            _card(
              isDarkMode: isDarkMode,
              title: 'Timings & Pricing',
              child: Text('Open: 9:00 AM - 10:00 PM\nPrice: Rs. 400/hr\nPer Day Cost: Rs. 3000', style: TextStyle(color: Colors.blue)),
            ),
            _card(
              isDarkMode: isDarkMode,
              title: 'Pricing Details',
              child: Text('Pre-Tax: Rs. 400/hr\nPost-Tax: Rs. 450/hr', style: TextStyle(color: Colors.blue)),
            ),
            ...
            _card(
              ...
              child: Wrap(
                spacing: 8,
                children: [
                  Chip(label: Text('Cafeteria', style: TextStyle(color: Colors.blue),)),
                  Chip(label: Text('Showers',style: TextStyle(color: Colors.blue),)),
                  Chip(label: Text('Parking',style: TextStyle(color: Colors.blue),)),
                  Chip(label: Text('Wi-Fi',style: TextStyle(color: Colors.blue),)),
                ],
              ),
            ),
            ...
            _card(
              ...
              child: Text('Cancellations must be made 24 hours before the booking time.', style: TextStyle(color: Colors.blue)),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  'Book Now',
                  style: TextStyle(fontFamily: 'Exo2', fontSize: 16, fontWeight: FontWeight.bold,color: Colors.blue[900]),
                ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, fontFamily: 'Exo2', color: Colors.blue)),
  ...
  Widget _reviewItem(String user, String review, bool isDarkMode) {
    return Padding(
      ...
      child: Text('$user: "$review"', style: const TextStyle(fontSize: 14, color: Colors.blue)),
    );
  }
